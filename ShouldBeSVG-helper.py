...
# Crontab entry: 11 2,10,18 * * * jlocal
#   /data/project/anticompositebot/AntiCompositeBot/ShouldBeSVG-helper.py
...
try:
    ...
    command = ['jsub', '-m', 'n', '-j', 'y', '-N',
               'ShouldBeSVG-{report}'.format(report=report), '-q',
               '{toolpath}/ShouldBeSVG.py'.format(toolpath=toolpath), report]
