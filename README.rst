...
.. image:: https://img.shields.io/badge/python-v3.13-blue
    :alt: Python version 3.13
...
Updating dependencies
    ...
    ``pip`` (or ``upgrade.sh``) must always be run from within ``webservice shell``.
