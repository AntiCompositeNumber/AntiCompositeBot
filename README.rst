...
.. image:: https://img.shields.io/badge/python-v3.11-blue
    :alt: Python version 3.11
...
Updating dependencies
    ...
    ``pip`` (or ``upgrade.sh``) must always be run from within ``webservice shell``. The Toolforge bastion runs Python 3.5, but the Kubernetes containers used to run the bot use Python 3.11. Virtual environments created in Python 3.5 won't run correctly in Python 3.11.
